...
<tr>
	...
	<table summary="" cellpadding="0" cellspacing="0" border="0"
		...
		<tr>
			...
			<td><img src="images/grid/ftrMenuSeparator.gif" width="1"
				height="16" alt="" /></td>
			<td align="center" height="20" class="footerMenuItem"
				onmouseover="changeMenuStyle(this,'footerMenuItemOver'),showCursor()"
				onmouseout="changeMenuStyle(this,'footerMenuItem'),hideCursor()"
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<div align="center"><a href="http://www.cancer.gov/"><img
				src="images/grid/footer_one.gif" width="63" height="31" border="0"></a> <a
				href="http://www.dhhs.gov/"><img
				src="images/grid/footer_two.gif" width="39" height="31" border="0"></a> <a
				href="http://www.nih.gov/"><img
				src="images/grid/footer_three.gif" width="46" height="31" border="0"></a> <a
				href="http://www.firstgov.gov/"><img
				src="images/grid/footer_four.gif" width="91" height="31" border="0"></a></div>
			</td>
		</tr>
	</table>
	<!-- footer ends --></td>
