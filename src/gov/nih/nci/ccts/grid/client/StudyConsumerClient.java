...
public class StudyConsumerClient extends StudyConsumerClientBase implements StudyConsumerI {	
    ...
    private gov.nih.nci.cabig.ccts.domain.Study getStudy(final String studyMessageFile) throws Exception {
        FileReader reader = new FileReader(studyMessageFile);
        InputStream is = getClass().getResourceAsStream("client-config.wsdd");
        gov.nih.nci.cabig.ccts.domain.Study study = (gov.nih.nci.cabig.ccts.domain.Study) Utils.deserializeObject(reader, gov.nih.nci.cabig.ccts.domain.Study.class, is);
        ...
        try {
            if (!(args.length < 2)) {
                if (args[0].equals("-url")) {
                    ...
                    gov.nih.nci.cabig.ccts.domain.Study notificationType = client.getStudy(
                            "/Users/saurabhagrawal/projects/latest/psc-2.1/grid/study-consumer/test/resources/SampleStudyMessage.xml");
                    client.createStudy(notificationType);
