 ...
 * 
 */
public abstract class LabConsumerServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(LabConsumerServiceResourceBase.class);

	private LabConsumerServiceResourceConfiguration configuration;
    ...
    public LabConsumerServiceResourceBase() {
    }
	...
	public LabConsumerServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/LabConsumerService";
		...
		try {
			...
			this.configuration = (LabConsumerServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
