...
public class SmokeTestServiceClient extends SmokeTestServiceClientBase implements SmokeTestServiceI {	
	...
	public SmokeTestServiceClient(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	}
	
	public SmokeTestServiceClient(EndpointReferenceType epr) throws MalformedURIException, RemoteException {
	   	this(epr,null);
	}
	
	public SmokeTestServiceClient(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
	}
	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
			if(args[0].equals("-url")){
			  SmokeTestServiceClient client = new SmokeTestServiceClient(args[1]);
