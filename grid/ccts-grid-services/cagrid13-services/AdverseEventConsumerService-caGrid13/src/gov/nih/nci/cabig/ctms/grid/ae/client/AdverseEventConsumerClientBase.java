 ...
 */
public abstract class AdverseEventConsumerClientBase extends ServiceSecurityClient {	
	...
	public AdverseEventConsumerClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public AdverseEventConsumerClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected AdverseEventConsumerPortType createPortType() throws RemoteException {
