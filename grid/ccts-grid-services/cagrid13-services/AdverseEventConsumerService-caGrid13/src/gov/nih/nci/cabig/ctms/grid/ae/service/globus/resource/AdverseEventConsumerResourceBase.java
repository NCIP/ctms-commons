 ...
 * 
 */
public abstract class AdverseEventConsumerResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(AdverseEventConsumerResourceBase.class);

	private AdverseEventConsumerResourceConfiguration configuration;
    ...
    public AdverseEventConsumerResourceBase() {
    }
