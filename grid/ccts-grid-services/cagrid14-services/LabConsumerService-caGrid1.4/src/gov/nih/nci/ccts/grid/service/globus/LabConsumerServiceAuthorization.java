 ...
 * 
 */
public class LabConsumerServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://grid.ccts.nci.nih.gov/LabConsumerService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public LabConsumerServiceAuthorization() {
	}
