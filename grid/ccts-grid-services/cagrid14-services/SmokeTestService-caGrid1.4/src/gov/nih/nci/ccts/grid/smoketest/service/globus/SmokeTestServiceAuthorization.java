 ...
 * 
 */
public class SmokeTestServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://smoketest.grid.ccts.nci.nih.gov/SmokeTestService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SmokeTestServiceAuthorization() {
	}
	...
	public void authorizePing(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("ping")){
			authorizePing(peerSubject, context, operation);
			return true;
