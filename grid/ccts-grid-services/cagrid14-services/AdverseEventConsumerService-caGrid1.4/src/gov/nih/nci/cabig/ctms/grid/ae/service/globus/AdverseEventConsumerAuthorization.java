 ...
 * 
 */
public class AdverseEventConsumerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://ae.grid.ctms.cabig.nci.nih.gov/AdverseEventConsumer";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AdverseEventConsumerAuthorization() {
	}
